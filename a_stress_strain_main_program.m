...
[A_joint1,beta_joint1,R2_joint1,Document,Content,Selection,Num,n_table,A_average1,beta_average1,R2_average1,n_title2,n_title3]=fit_data_figures_with_beta(fileadress,filename,I,Document,Content,Selection,Num,n_table,n_title2,n_title3);


[C_A1,C_beta1,C_b1,C_R21,Document,Content,Selection,Num,n_table,n_title2,n_title3]=fit_data_figures_with_b(fileadress,filename,I,Document,Content,Selection,Num,n_table,n_title2,n_title3,beta_c1,beta_c2);


[A_joint_alph,beta_joint,alpha_joint,R2_joint_beta,R2_joint_alph,Document,Content,Selection,Num,n_table,A_average_alph,average_beta,average_alph,R2_average_beta,R2_average_alph,n_title2,n_title3]=fit_data_figures_with_alpha_beta(fileadress,filename,I,Document,Content,Selection,Num,n_table,n_title2,n_title3);


% [I0]=fitted_and_original_data_save(A_joint,beta_joint,b_joint,R2_joint,A_average,beta_average,b_average,R2_average,C_A,C_beta,C_b,C_R2,fileadress,filename);
